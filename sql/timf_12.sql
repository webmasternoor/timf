...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 12, 2017 at 10:37 AM
...
(2, NULL, 'Thengamara', '2', '2017-01-10 10:03:18', '2017-01-12 08:16:11'),
(3, NULL, 'Gazipur', '1', '2017-01-11 04:34:22', '2017-01-12 08:16:07');
...
(5, NULL, 'গরু', '2017-01-11 07:09:41', '2017-01-12 09:22:37'),
(6, NULL, 'ছাগল', '2017-01-12 09:22:27', '2017-01-12 09:22:27');
...
(0, NULL, '2', 'Dublia', '2017-01-10 10:25:12', '2017-01-12 08:16:59'),
(1, NULL, '1', 'Hazir Hat', '2017-01-12 08:16:51', '2017-01-12 08:16:51');
...
(0, NULL, 'Bangladesh', '001', '2017-01-12 08:15:31', '2017-01-12 08:15:31'),
(0, NULL, 'Nepal', '002', '2017-01-12 08:15:38', '2017-01-12 08:15:38');
...
(0, 'Pabna', NULL, NULL, '3', 'পাবনা', '50.00', '30.00', '0.00', '2017-01-12 08:53:15', '2017-01-12 08:53:39');
...
(0, NULL, 'Dhaka', 'ঢাকা', '0.00', '2017-01-12 08:52:09', '2017-01-12 08:52:24');
...
(1, '1', NULL, 'চামেলি', 'জিয়া', '4', '5', '6', NULL, '2017-01-12 09:21:56'),
(2, '7', NULL, '6', 'নুর ই আলম খান', '২৩৪', '4', '3', '2017-01-08 10:38:07', '2017-01-12 09:22:07'),
...
--
-- Table structure for table `liabilitiess`
--

CREATE TABLE `liabilitiess` (
  `id` int(11) NOT NULL,
  `name` varchar(500) DEFAULT NULL,
  `LiabilitiesCode` varchar(500) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `liabs` (`id`, `LiabilitiesDescription`, `name`, `created_at`, `updated_at`) VALUES
(5, 'ব্যাংক', '8', '2017-01-11 07:03:24', '2017-01-11 08:16:06'),
(6, 'সমিতি', NULL, '2017-01-11 08:16:39', '2017-01-11 08:16:39'),
(7, 'দোকান বাকী', NULL, '2017-01-12 09:23:01', '2017-01-12 09:23:12');
...
(1, '002', 'Proshika', 'Agargao', '১২/১/২০১৭', '', '', '', '', '', '', '', '1', '', '', '', NULL, '2017-01-11 09:55:57', '2017-01-12 09:19:48'),
(2, '001', 'TMSS', '665/5, mirpur 10, dhaka', '11/01/2017', '', '', '', '', '', '', '', '1', '', '', '', NULL, '2017-01-12 09:18:27', '2017-01-12 09:19:14');
...
(5, 'Mirpur', '2', NULL, '2017-01-11 04:18:00', '2017-01-12 08:55:53');
...
(1, 'fgh56', 'sadfgdg', 'sdfgsg', 'sdgfdg', 'asfdg', '1', '', '', '', '', '', '', '', '', '', '1', '1', '', '', NULL, NULL, '2017-01-12 09:20:38'),
(2, 'xcvbcne', 'xcbc87e', 'b ne', 'xcbcve', 'xcbncve', '1', '456', '', '', '', '', '', '', '', '', '1', '1', '', '', NULL, '2017-01-11 10:08:49', '2017-01-12 09:20:52'),
(3, '123', 'ertdfgb', 'dsfgh', 'dsfg', 'gdfsdhgsf', '1', '', '', '', '', '', '', '', '', '', '1', '1', '', '', NULL, '2017-01-12 09:21:13', '2017-01-12 09:21:13');
...
(2, '', '', '1', '1', '1', '1', '1', '2', '3', '4', '1', '0', '1', '0', '1', '1', '2', '0', '2', '3', '4', '0', '1', '1', '1', '5', '1', '1', '1', '1', '1', '0', '7', '8', '1', '1', '1', '1', '1', '0', '8', '7', '6', '5@gmail.com', '9098', '0', '1', '1', '0', '7', '65', '1', '8', '0', '0', '0', '0', '0', '0', '1', 'sd', 'sd', 'sd', '34', '34', '34', '34', '34', '34', '34', '34', '34', '34', '34', '34', '34', '34', '34', '', '1', 'fsfsf', '34', '2017-01-03', '1', 'ffffdf', '3434', 'fdf', 'df', '0', '2017-01-07 05:56:17', '2017-01-07 05:56:17');
...
(6, 'মোহাম্মাদপুর', 'Mohammadpur', '1', NULL, '2017-01-11 03:47:57', '2017-01-12 08:54:40'),
(0, 'মিরপুর', 'Mirpur', '1', NULL, '2017-01-12 08:54:09', '2017-01-12 08:54:52');
...
(2, 'Hemayetpur', NULL, NULL, '2017-01-11 03:59:45', '2017-01-12 08:55:30'),
(0, 'Dhankura', NULL, NULL, '2017-01-12 08:55:15', '2017-01-12 08:55:34');
...
(0, '৫ নং', '1', NULL, '2017-01-12 08:56:53', '2017-01-12 08:56:53');
...
(1, '1', 'Dhaka', '3', '4.00', '2017-01-02 09:54:44', '2017-01-12 08:11:57'),
(2, '7', 'Bogra', '9', '8.00', '2017-01-03 04:40:20', '2017-01-12 08:11:28'),
(3, NULL, 'Rajshahi', NULL, '0.00', '2017-01-12 08:11:44', '2017-01-12 08:11:44');
...
ALTER TABLE `bussinesscashinflows`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `bussinesscashinflows` ADD FULLTEXT KEY `idx_name` (`name`);
...
ALTER TABLE `bussinesscashoutflows`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `bussinesscashoutflows` ADD FULLTEXT KEY `idx_name` (`name`);
...
ALTER TABLE `jamindars`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `jamindars` ADD FULLTEXT KEY `idx_name` (`name`);

--
-- Indexes for table `liabilitiess`
--
ALTER TABLE `liabilitiess`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `liabilitiess` ADD FULLTEXT KEY `idx_name` (`name`);
...
ALTER TABLE `liabs`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `liabs` ADD FULLTEXT KEY `idx_name` (`name`);
...
ALTER TABLE `jamindars`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `liabilitiess`
--
ALTER TABLE `liabilitiess`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
