<div class="col-md-12">
    <div class="borderportion">
        <div class="form-group required col-md-6" id="form-Membertype-error">
            {!! Form::label("Membertype","সদস্যের ধরন",["class"=>"control-label col-md-12"]) !!}
            <div class="col-md-12">
                {!! Form::text("Membertype",null,["class"=>"form-control Membertype required","id"=>"Membertype"]) !!}
    ...
    <div class="borderportion">
        ...
        $i=1;
        ?>
        @foreach($ProductInfo as $Product_Data)
            <div class="form-group required col-md-4" id="form-DistrictId-error">
                {!! Form::label("DistrictId",$Product_Data->ProductID,["class"=>"control-label col-md-12"]) !!}
                <div class="col-md-12">
                    {!!  Form::checkbox('name'.$i, $Product_Data->id,null)!!}
    ...
    <input  type="hidden" name="countvalue" value="{{$value1}}">
</div>
<div class="form-group">
    <div class="col-md-6 col-md-push-3">
        <a href="javascript:ajaxLoad('membertype/list')" class="btn btn-danger"><i
