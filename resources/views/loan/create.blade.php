	...
	<div class="col-sm-7 form-group">
	    <div class="input-group">
	        <input class="form-control" id="search1" value="{{ Session::get('loan_search1') }}"
	               onkeydown="if (event.keyCode == 13) ajaxLoad('{{url('loan/create')}}?ok=1&search1='+this.value)"
	               placeholder="Survey Search [NID].."
	               type="text">

	        <div class="input-group-btn">
	            <button type="button" class="btn btn-default"
	                    onclick="ajaxLoad('{{url('loan/create')}}?ok=1&search1='+$('#search1').val())"><i
	        ...
	        <tr>
	            ...
	            <td style="text-align: center">
	                <a class="btn btn-primary btn-xs" title="Edit"
	                   href="javascript:ajaxLoad('survey/view/{{$loan->id}}')">
